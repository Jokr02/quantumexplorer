...
export function CameraController() {
    ...
    useFrame((_, delta) => {
        ...
        let targetZ = 5;
        if (newScale > 2) {
            // Atomic(2) to Molecular(14) -> 15 to 60 (Adjusted from 140 to bring it much closer)
            targetZ = THREE.MathUtils.mapLinear(newScale, 2, 14, 15, 60);
        } else {
            // Atomic(2) to Subatomic(0.5) -> 15 to 5
            // Increased min Z from 2.5 to 5.0 to prevent clipping into the Nucleus
